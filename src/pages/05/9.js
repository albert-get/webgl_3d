...
void main()
{
      ...
      fragColor=vec4(lightColor.xyz,1.0);
                ...
                ball=new Ball(gl,shaderProgArray[0],)
            ...
            function drawFrame()
            {
                ...
                let lightOffset = 0;//获得当前拖拉条的值
                lightManager.setLightLocation(lightOffset,0,1);
    ...
    return (
        <div>
            <>
                ...
                <Script type="text/javascript" src="/js/Ball5.js"></Script>

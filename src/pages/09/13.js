...
\t//将法向量转化进视空间
\tvec4 ydskj=uuMVPMatrix*vec4(0,0,0,1);
\tvec4 fxldskj=uuMVPMatrix*vec4(aNormal.xyz,1.0);
\tvec2 skjNormal=fxldskj.xy-ydskj.xy;
\tskjNormal=normalize(skjNormal);
\tvec4 finalPosition=uuMVPMatrix * vec4(position.xyz,1);
    ...
    return (
        <div>
            <>
                ...
                <Script type="text/javascript" src="/js/loadObject2.js"></Script>
                <Script type="text/javascript" src="/js/FrameGlobalVar10.js"></Script>
